...
export default function Contact() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col gap-4 items-center justify-center text-white px-4 py-20">
      ...
      <div
        className="absolute w-[900px] h-[900px] rounded-full blur-3xl opacity-30 -z-10 top-[-100px] left-[-300px]"
        style={{
          background:
            "radial-gradient(circle, #f59e42 0%, #000 60%, #6abcff 100%)",
        }}
      />
      <div className="relative z-10 w-full max-w-2xl p-10 rounded-3xl backdrop-blur-xl bg-white/5 border border-white/20 shadow-[0_0_40px_rgba(255,255,255,0.1)]">
        ...
        <form className="grid gap-6">
          ...
          <textarea
            ...
            className="bg-transparent border border-white/20 rounded-xl px-4 py-3 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 h-32 resize-none"
          />
          <button
            type="button"
