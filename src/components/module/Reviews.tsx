    ...
    <section className="py-20 relative min-h-[calc(100vh / 2)]">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {users.map((user) => (
          <div
            key={user.name}
            className="relative rounded-3xl p-6 bg-white/5 backdrop-blur-xl border border-white/10 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300"
          >
            {/* Inner radial light */}
